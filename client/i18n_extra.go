...
func init() {
	...
	settingsStrings["de"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Wie es funktioniert</p>" +
			...
			"<li>Die Farbe des ganzen Programms — Fenster, Leiste, Tastenkürzel-Fenster und Symbol im Infobereich — kommt aus einer Liste „Farben“ im Bereich „System“: Grün als Standard, Bernstein, Blau und Rosa. Die Wahl gilt sofort, ohne Neustart.</li>" +
			"</ul>" +
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Comment ça marche</p>" +
			...
			"<li>La couleur de tout le programme — la fenêtre, le bandeau, la fenêtre du raccourci et l'icône — vient d'une seule liste « Couleurs » dans la section « Système » : vert par défaut, ambre, bleu et rose. Le choix s'applique aussitôt, sans redémarrage.</li>" +
			"</ul>" +
	...
	settingsStrings["es"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Cómo funciona</p>" +
			...
			"<li>El color de todo el programa — la ventana, la barra, la ventana del atajo y el icono — sale de una sola lista «Colores» en la sección «Sistema»: verde por defecto, ámbar, azul y rosa. La elección se aplica al momento, sin reiniciar.</li>" +
			"</ul>" +
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Come funziona</p>" +
			...
			"<li>Il colore di tutto il programma — la finestra, la barra, la finestra della scorciatoia e l'icona — viene da un solo elenco «Colori» nella sezione «Sistema»: verde come predefinito, ambra, blu e rosa. La scelta vale subito, senza riavvio.</li>" +
			"</ul>" +
	...
	settingsStrings["pl"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Jak to działa</p>" +
			...
			"<li>Kolor całego programu — okna, paska, okna skrótu i ikony w zasobniku — bierze się z jednej listy „Kolory” w sekcji „System”: zielony domyślnie, bursztynowy, niebieski i różowy. Wybór działa od razu, bez ponownego uruchamiania.</li>" +
			"</ul>" +
	...
	settingsStrings["uk"] = map[string]string{
		...
		"S_HELP_HTML": "<p class=\"wh\">Як це працює</p>" +
			...
			"<li>Колір усього застосунку — вікна, смужки, вікна сполучення та значка в лотку — задається одним списком «Оформлення» в розділі «Система»: зелена палітра за замовчуванням, бурштинова, синя та рожева. Вибір діє одразу, без перезапуску.</li>" +
			"</ul>" +
