...
func init() {
	...
	settingsStrings["de"] = map[string]string{
		...
		"S_DICT": "Erkennungswörterbuch", "S_DICT_HINT": "Begriffe, Namen und Abkürzungen, durch Kommas getrennt — ein Hinweis fürs Gehör, keine Befehle. Gilt für Whisper; russische Sprache über GigaAM ignoriert das. Der Standardsatz folgt der Erkennungssprache, bis Sie eigenes eintragen.",
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_DICT": "Dictionnaire de reconnaissance", "S_DICT_HINT": "Termes, noms et abréviations séparés par des virgules — un indice pour l'oreille, pas des commandes. Cela vaut pour Whisper ; le russe via GigaAM l'ignore. Le jeu par défaut suit la langue de reconnaissance jusqu'à ce que vous écriviez le vôtre.",
	...
	settingsStrings["es"] = map[string]string{
		...
		"S_DICT": "Diccionario de reconocimiento", "S_DICT_HINT": "Términos, nombres y abreviaturas separados por comas — una pista para el oído, no comandos. Vale para Whisper; el ruso a través de GigaAM lo ignora. El conjunto por defecto sigue al idioma de reconocimiento hasta que escribas el tuyo.",
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_DICT": "Dizionario di riconoscimento", "S_DICT_HINT": "Termini, nomi e abbreviazioni separati da virgole — un suggerimento per l'ascolto, non comandi. Vale per Whisper; il russo tramite GigaAM lo ignora. Il set predefinito segue la lingua di riconoscimento finché non scrivi il tuo.",
	...
	settingsStrings["pl"] = map[string]string{
		...
		"S_DICT": "Słownik rozpoznawania", "S_DICT_HINT": "Terminy, nazwy i skróty oddzielone przecinkami — podpowiedź dla słuchu, nie polecenia. Działa dla Whispera; rosyjska mowa przez GigaAM tego nie używa. Zestaw domyślny podąża za językiem rozpoznawania, dopóki nie wpiszesz własnego.",
	...
	settingsStrings["uk"] = map[string]string{
		...
		"S_DICT": "Словник розпізнавання", "S_DICT_HINT": "Терміни, імена та абревіатури через кому — підказка слуху, не команди. Працює для Whisper; російська мова через GigaAM це ігнорує. Типовий набір іде за мовою розпізнавання, доки ви не впишете своє.",
