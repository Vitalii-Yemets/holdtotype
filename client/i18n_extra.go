...
func init() {
	msgs["de"] = map[string]string{
		...
		"ov.speak": "Sprechen…", "ov.transcribing": "Erkenne", "ov.asking": "Warte auf Ihre Antwort", "ov.inserted": "Eingefügt: %d Zeichen",
	...
	msgs["fr"] = map[string]string{
		...
		"ov.speak": "Parlez…", "ov.transcribing": "Reconnaissance", "ov.asking": "En attente de votre réponse", "ov.inserted": "Inséré : %d caractères",
	...
	msgs["es"] = map[string]string{
		...
		"ov.speak": "Hable…", "ov.transcribing": "Reconociendo", "ov.asking": "Esperando tu respuesta", "ov.inserted": "Insertado: %d caracteres",
	...
	msgs["it"] = map[string]string{
		...
		"ov.speak": "Parla…", "ov.transcribing": "Riconoscimento", "ov.asking": "Attendo la tua risposta", "ov.inserted": "Inserito: %d caratteri",
	...
	msgs["pl"] = map[string]string{
		...
		"ov.speak": "Mów…", "ov.transcribing": "Rozpoznawanie", "ov.asking": "Czekam na odpowiedź", "ov.inserted": "Wstawiono: %d znaków",
	...
	msgs["uk"] = map[string]string{
		...
		"fd.keep":  "Залишити",
		"ov.speak": "Говоріть…", "ov.transcribing": "Розпізнаю", "ov.asking": "Чекаю на відповідь", "ov.inserted": "Вставлено: %d символів",
