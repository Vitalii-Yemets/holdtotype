...
func init() {
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_GRP_GENERAL": "Général", "S_GRP_SPEECH": "Parole", "S_GRP_TEXT": "Texte", "S_GRP_INFO": "Infos", "S_NAV_POST": "Post-traitement", "S_NAV_HELP": "Aide", "S_NAV_CONTACTS": "Contacts", "S_LIB_REC": "Reconnaissance vocale", "S_LIB_INST": "Installés", "S_LIB_AVAIL": "Disponibles au téléchargement", "S_LIB_ACTIVE": "active", "S_LIB_STANDBY": "réserve", "S_LIB_FIND": "Chercher un modèle…", "S_DICT_MODEL": "Modèle de reconnaissance", "S_TR_BY": "La traduction sera faite par %s",
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_GRP_GENERAL": "Generale", "S_GRP_SPEECH": "Voce", "S_GRP_TEXT": "Testo", "S_GRP_INFO": "Info", "S_NAV_POST": "Post-elaborazione", "S_NAV_HELP": "Guida", "S_NAV_CONTACTS": "Contatti", "S_LIB_REC": "Riconoscimento vocale", "S_LIB_INST": "Installati", "S_LIB_AVAIL": "Disponibili da scaricare", "S_LIB_ACTIVE": "attiva", "S_LIB_STANDBY": "riserva", "S_LIB_FIND": "Cerca modello…", "S_DICT_MODEL": "Modello di riconoscimento", "S_TR_BY": "La traduzione sarà eseguita da %s",
