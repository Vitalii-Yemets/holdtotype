...
func init() {
	...
	settingsStrings["de"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "klicken Sie einen Punkt oder ziehen Sie die Leiste an eine beliebige Stelle",
		...
		"S_DICT_WHISPER_ONLY": "Das Wörterbuch lesen nur Whisper-Modelle — GigaAM, Parakeet und die übrigen sehen den Hinweis nie.",
		...
		"S_POSTAPI": "Externer Server (OpenAI-kompatibel)",
		...
		"S_POST_MODEL": "Modell",
		"S_SRC_LOCAL": "Lokal — auf diesem Computer",
		"S_SRC_USED": "in Gebrauch",
		"S_SRC_IDLE": "nicht in Gebrauch — zum Umschalten klicken",
		"S_POST_OFF": "aus",
		"S_HF_GO": "Suchen",
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "cliquez un point, ou glissez la vignette où vous voulez",
		...
		"S_DICT_WHISPER_ONLY": "Seuls les modèles Whisper lisent le dictionnaire — GigaAM, Parakeet et les autres ne voient jamais l’indice.",
		...
		"S_POSTAPI": "Serveur externe (compatible OpenAI)",
		...
		"S_POST_MODEL": "Modèle",
		"S_SRC_LOCAL": "Locale — sur cet ordinateur",
		"S_SRC_USED": "utilisée",
		"S_SRC_IDLE": "non utilisée — cliquez pour l’activer",
		"S_POST_OFF": "désactivée",
		"S_HF_GO": "Rechercher",
		...
		"S_POSTAPI_TIMEOUT": "Délai de réponse",
	...
	settingsStrings["es"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "haga clic en un punto o arrastre la placa a donde quiera",
		...
		"S_DICT_WHISPER_ONLY": "Solo los modelos Whisper leen el diccionario — GigaAM, Parakeet y el resto nunca ven la pista.",
		...
		"S_POSTAPI": "Servidor externo (compatible con OpenAI)",
		...
		"S_POST_MODEL": "Modelo",
		"S_SRC_LOCAL": "Local — en este equipo",
		"S_SRC_USED": "en uso",
		"S_SRC_IDLE": "sin usar — haga clic para activarlo",
		"S_POST_OFF": "apagada",
		"S_HF_GO": "Buscar",
		...
		"S_POSTAPI_TIMEOUT": "Tiempo de espera",
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "cliccate un punto o trascinate la targhetta dove volete",
		...
		"S_DICT_WHISPER_ONLY": "Solo i modelli Whisper leggono il dizionario — GigaAM, Parakeet e gli altri non vedono mai il suggerimento.",
		...
		"S_POSTAPI": "Server esterno (compatibile OpenAI)",
		...
		"S_SRC_LOCAL": "Locale — su questo computer",
		"S_SRC_USED": "in uso",
		"S_SRC_IDLE": "non in uso — fate clic per attivarlo",
		"S_POST_OFF": "spenta",
		"S_HF_GO": "Cerca",
		...
		"S_POSTAPI_TIMEOUT": "Attesa della risposta",
	...
	settingsStrings["pl"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "kliknij punkt albo przeciągnij plakietkę w dowolne miejsce",
		...
		"S_DICT_WHISPER_ONLY": "Słownik czytają tylko modele Whisper — GigaAM, Parakeet i pozostałe nigdy nie widzą podpowiedzi.",
		...
		"S_POSTAPI": "Serwer zewnętrzny (zgodny z OpenAI)",
		...
		"S_POST_MODEL": "Model",
		"S_SRC_LOCAL": "Lokalny — na tym komputerze",
		"S_SRC_USED": "w użyciu",
		"S_SRC_IDLE": "nieużywany — kliknij, aby włączyć",
		"S_POST_OFF": "wyłączona",
		"S_HF_GO": "Szukaj",
		...
		"S_POSTAPI_TIMEOUT": "Czas oczekiwania",
	...
	settingsStrings["uk"] = map[string]string{
		...
		"S_OVPOS_SCHEME_SUB": "клацніть точку або перетягніть плашку куди завгодно",
		...
		"S_DICT_WHISPER_ONLY": "Словник читають лише моделі Whisper — GigaAM, Parakeet та решта підказки не бачать.",
		...
		"S_POSTAPI": "Зовнішній сервер (сумісний з OpenAI)",
		...
		"S_POST_MODEL": "Модель",
		"S_SRC_LOCAL": "Локальна — на цьому комп’ютері",
		"S_SRC_USED": "використовується",
		"S_SRC_IDLE": "не використовується — клацніть, щоб увімкнути",
		"S_POST_OFF": "вимкнена",
		"S_HF_GO": "Знайти",
		...
		"S_POSTAPI_TIMEOUT": "Очікування відповіді",
