...
func init() {
	...
	settingsStrings["de"] = map[string]string{
		...
		"S_HIST_LIST": "Einträge", "S_HIST_CLEAR": "Leeren", "S_HIST_TILL": "bis %s", "S_HIST_TILL1": "bis morgen", "S_HIST_TILL_FULL": "Wird am %s gelöscht — Aufbewahrung %d Tage", "S_HIST_LIST_HINT": "Was diktiert wurde: kopieren, in ein beliebiges Fenster einfügen oder löschen.", "S_HIST_COPY": "Kopieren",
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_HIST_LIST": "Entrées", "S_HIST_CLEAR": "Vider", "S_HIST_TILL": "jusqu'au %s", "S_HIST_TILL1": "jusqu'à demain", "S_HIST_TILL_FULL": "Sera supprimé le %s — conservation %d jours", "S_HIST_LIST_HINT": "Ce qui a été dicté : copier, coller dans n'importe quelle fenêtre ou supprimer.", "S_HIST_COPY": "Copier",
	...
	settingsStrings["es"] = map[string]string{
		...
		"S_HIST_LIST": "Entradas", "S_HIST_CLEAR": "Vaciar", "S_HIST_TILL": "hasta %s", "S_HIST_TILL1": "hasta mañana", "S_HIST_TILL_FULL": "Se borrará el %s — se guarda %d días", "S_HIST_LIST_HINT": "Lo que se dictó: copiar, pegar en cualquier ventana o borrar.", "S_HIST_COPY": "Copiar",
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_HIST_LIST": "Voci", "S_HIST_CLEAR": "Svuota", "S_HIST_TILL": "fino al %s", "S_HIST_TILL1": "fino a domani", "S_HIST_TILL_FULL": "Sarà cancellato il %s — conservazione %d giorni", "S_HIST_LIST_HINT": "Quello che è stato dettato: copiare, incollare in qualsiasi finestra o cancellare.", "S_HIST_COPY": "Copia",
	...
	settingsStrings["pl"] = map[string]string{
		...
		"S_HIST_LIST": "Wpisy", "S_HIST_CLEAR": "Wyczyść", "S_HIST_TILL": "do %s", "S_HIST_TILL1": "do jutra", "S_HIST_TILL_FULL": "Zostanie usunięte %s — przechowywanie %d dni", "S_HIST_LIST_HINT": "To, co podyktowano: skopiować, wkleić do dowolnego okna lub usunąć.", "S_HIST_COPY": "Kopiuj",
	...
	settingsStrings["uk"] = map[string]string{
		...
		"S_HIST_LIST": "Записи", "S_HIST_CLEAR": "Очистити", "S_HIST_TILL": "до %s", "S_HIST_TILL1": "до завтра", "S_HIST_TILL_FULL": "Буде видалено %s — термін зберігання %d днів", "S_HIST_LIST_HINT": "Те, що надиктовано: скопіювати, вставити в будь-яке вікно або видалити.", "S_HIST_COPY": "Копіювати",
