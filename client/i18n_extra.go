...
func init() {
	...
	settingsStrings["fr"] = map[string]string{
		...
		"S_POST_NO_MODEL": "activé, mais aucun modèle choisi", "S_POST_NO_API": "activé, mais le serveur n'est pas configuré", "S_POST_BAD": "le serveur n'a pas répondu : %s", "S_POST_NO_PROMPT": "activé, mais aucun prompt coché", "S_API_TEST": "Tester la connexion", "S_API_TEST_RUN": "Vérification…", "S_API_TEST_OK": "Le serveur a répondu", "S_RAM_AVAIL": "Mémoire disponible : %s Go sur %s Go", "S_RAM_OF": "%s Go sur %s Go",
	...
	settingsStrings["it"] = map[string]string{
		...
		"S_POST_NO_MODEL": "attiva, ma nessun modello scelto", "S_POST_NO_API": "attiva, ma il server non è configurato", "S_POST_BAD": "il server non ha risposto: %s", "S_POST_NO_PROMPT": "attiva, ma nessun prompt selezionato", "S_API_TEST": "Prova connessione", "S_API_TEST_RUN": "Controllo…", "S_API_TEST_OK": "Il server ha risposto", "S_RAM_AVAIL": "Memoria disponibile: %s GB di %s GB", "S_RAM_OF": "%s GB di %s GB",
	...
	settingsStrings["pl"] = map[string]string{
		...
		"S_POST_NO_MODEL": "włączone, ale nie wybrano modelu", "S_POST_NO_API": "włączone, ale serwer nie jest skonfigurowany", "S_POST_BAD": "serwer nie odpowiedział: %s", "S_POST_NO_PROMPT": "włączone, ale nie zaznaczono żadnego promptu", "S_API_TEST": "Test połączenia", "S_API_TEST_RUN": "Sprawdzam…", "S_API_TEST_OK": "Serwer odpowiedział", "S_RAM_AVAIL": "Dostępna pamięć: %s GB z %s GB", "S_RAM_OF": "%s GB z %s GB",
	...
	settingsStrings["uk"] = map[string]string{
		...
		"S_POST_NO_MODEL": "увімкнено, але модель не вибрано", "S_POST_NO_API": "увімкнено, але сервер не налаштовано", "S_POST_BAD": "сервер не відповів: %s", "S_POST_NO_PROMPT": "увімкнено, але не позначено жодного промпту", "S_API_TEST": "Тест з'єднання", "S_API_TEST_RUN": "Перевіряю…", "S_API_TEST_OK": "Сервер відповів", "S_RAM_AVAIL": "Доступно памʼяті %s ГБ із %s ГБ", "S_RAM_OF": "%s ГБ із %s ГБ",
