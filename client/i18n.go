...
var settingsStrings = map[string]map[string]string{
	"ru": {
		...
		"S_HIST_LIST": "Записи", "S_HIST_CLEAR": "Очистить", "S_HIST_TILL": "до %s", "S_HIST_TILL1": "до завтра", "S_HIST_TILL_FULL": "Удалится %s — срок хранения %d дней", "S_HIST_LIST_HINT": "Что было надиктовано: скопировать, вставить в любое окно или удалить.", "S_HIST_COPY": "Копировать",
	...
	"en": {
		...
		"S_HIST_LIST": "Entries", "S_HIST_CLEAR": "Clear", "S_HIST_TILL": "till %s", "S_HIST_TILL1": "till tomorrow", "S_HIST_TILL_FULL": "Will be deleted on %s — kept for %d days", "S_HIST_LIST_HINT": "What was dictated: copy it, paste it into any window, or delete it.", "S_HIST_COPY": "Copy",
