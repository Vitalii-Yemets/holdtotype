...
var msgs = map[string]map[string]string{
	"ru": {
		"app.name":              "Vox Terminal",
		"already.running":       "Приложение уже запущено (иконка в трее).",
		"err.title":             "Vox Terminal — ошибка",
		"cfg.err.title":         "Vox Terminal — ошибка конфигурации",
		"err.details":           "\n\nПодробности в voxterminal.log",
		...
		"err.server.repeat":     "whisper-server аварийно завершается раз за разом — подробности в voxterminal.log",
		...
		"cap.title":             "Vox Terminal — сочетание клавиш",
		...
		"about.text": "Vox Terminal %s\n\n" +
			...
			"Логи: voxterminal.log (не больше ~2 МБ).",
	},
	"en": {
		"app.name":              "Vox Terminal",
		"already.running":       "The application is already running (tray icon).",
		"err.title":             "Vox Terminal — error",
		"cfg.err.title":         "Vox Terminal — configuration error",
		"err.details":           "\n\nDetails in voxterminal.log",
		...
		"err.server.repeat":     "whisper-server keeps crashing — see voxterminal.log",
		...
		"cap.title":             "Vox Terminal — shortcut",
		...
		"un.done":               "Vox Terminal has been removed.",
		...
		"about.text": "Vox Terminal %s\n\n" +
			...
			"Logs: voxterminal.log (never exceeds ~2 MB).",
	},
}

var settingsStrings = map[string]map[string]string{
	"ru": {
		"S_TITLE":       "Vox Terminal — настройки",
		...
		"S_AUTHOR_HTML": "<p style=\"font-size:15px;letter-spacing:2px\"><b>Vitalii Yemets</b></p>" +
			"<p>Автор и разработчик Vox Terminal — локального диктовщика для Windows: голос превращается в текст прямо в позиции курсора, без облаков и подписок.</p>" +
			"<p>Проект открыт: исходный код, сборка и свежие версии — на GitHub.</p>" +
			"<ul>" +
			"<li>Репозиторий: <span class=\"lnk\" onclick=\"appRepoLink()\">github.com/Vitalii-Yemets/vox-terminal</span></li>" +
		...
		"S_HELP_HTML": "<p class=\"wh\">Как это работает</p>" +
			...
			"<ul>" +
			"<li><b>voxterminal-setup.exe</b> — инсталлер: ставит без прав администратора, ярлык в Пуске, опциональный автозапуск, корректное удаление через «Установку и удаление программ».</li>" +
			...
			"<li><b>voxterminal.log</b> — журнал работы, автоматически ограничен ~2 МБ.</li>" +
	...
	"en": {
		...
		"S_SUB_AUTHOR": "Author",
		"S_AUTHOR_HTML": "<p style=\"font-size:15px;letter-spacing:2px\"><b>Vitalii Yemets</b></p>" +
			"<p>Author and developer of Vox Terminal — a local dictation tool for Windows: voice becomes text right at the cursor, no clouds, no subscriptions.</p>" +
			"<p>The project is open: source code, build pipeline and fresh releases live on GitHub.</p>" +
			"<ul>" +
			"<li>Repository: <span class=\"lnk\" onclick=\"appRepoLink()\">github.com/Vitalii-Yemets/vox-terminal</span></li>" +
		...
		"S_HELP_HTML": "<p class=\"wh\">How it works</p>" +
			...
			"<ul>" +
			"<li><b>voxterminal-setup.exe</b> — the installer: no admin rights needed, Start Menu shortcut, optional autostart, clean removal via \"Apps & features\".</li>" +
			...
			"<li><b>voxterminal.log</b> — the log, automatically capped at ~2 MB.</li>" +
