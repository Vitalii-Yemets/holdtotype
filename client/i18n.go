...
var settingsStrings = map[string]map[string]string{
	"ru": {
		...
		"S_POST_MODEL": "Модель",
		"S_SRC_LOCAL": "Локальная — на этом компьютере",
		"S_SRC_USED": "используется",
		"S_SRC_IDLE": "не используется — щёлкните, чтобы включить",
		"S_POST_OFF": "выключена",
		"S_HF_GO": "Найти",
	...
	"en": {
		...
		"S_POST_MODEL": "Model",
		"S_SRC_LOCAL": "Local — on this computer",
		"S_SRC_USED": "in use",
		"S_SRC_IDLE": "not in use — click to switch to it",
		"S_POST_OFF": "off",
		"S_HF_GO": "Search",
