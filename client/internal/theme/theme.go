...
var palettes = []Palette{
	...
	{ID: "neon", Bg: "#150a22", Panel: "#1d0e30", Line: "#4a2472",
		...
		BtnBg: "linear-gradient(90deg,#ff5fc8,#46e0ff)", BtnFg: "#150a22", BtnLine: "transparent",
		SelBg: "linear-gradient(90deg,#ff5fc8,#46e0ff)", SelFg: "#150a22",
		BtnBgH: "linear-gradient(90deg,#ff7ad3,#6ce7ff)",
		Btn2Bg: "linear-gradient(90deg,#ff5fc8,#46e0ff)", Btn2Fg: "#150a22", Btn2Line: "transparent",
		Btn2BgH: "linear-gradient(90deg,#ff7ad3,#6ce7ff)",
		DangerBg: "#ff4d7d", DangerFg: "#150a22", DangerBgH: "#ff6f97",
