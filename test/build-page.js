...
const PALETTES = {
  ...
  paper: { bg: "#e7eaee", panel: "#f3f5f7", line: "#ced5dc", text: "#1f2328", hi: "#0969da", dim: "#59636e", faint: "#818b98", warn: "#9a6700", bad: "#cf222e", rec: "#cf222e", field: "#ffffff", card: "#f7f9fa", soft: "#dde2e8", navon: "#dfe5eb", on: "#ddf4ff", ok: "#1a7f37", btnbgh: "#0860ca", btn2bg: "#0969da", btn2fg: "#ffffff", btn2line: "transparent", btn2bgh: "#0860ca", dangerbg: "#cf222e", dangerfg: "#ffffff", dangerbgh: "#a40e26", dot: "#1a7f37", focus: "#0969da" },
};
const SKINS = {
