...
const PALETTES = {
  ...
  editor: { bg: "#1e1e1e", panel: "#252526", line: "#3c3c3c", text: "#d4d4d4", hi: "#4fc1ff", dim: "#9d9d9d", faint: "#6e6e6e", warn: "#cca700", bad: "#f14c4c", rec: "#f14c4c", field: "#3c3c3c", card: "#252526", soft: "#2d2d2d", navon: "#37373d", on: "#094771", btnbgh: "#1177bb", btn2bg: "#0e639c", btn2fg: "#ffffff", btn2line: "transparent", btn2bgh: "#1177bb", focus: "#007fd4" },
...
const SKINS = {
  ...
  editor: { palette: "editor", font: '"Segoe UI Variable Text","Segoe UI",system-ui,sans-serif', fs: "13px", r: "8px", dotr: "50%", badger: "10px", panelr: "6px", radius: 4, bw: "1px", scan: "0", shadow: "0 10px 30px rgba(0,0,0,.45)", glow: false, round: false, caps: false, fieldpad: "6px 11px", ctlfs: "12.5px", wb: "600", level: "flat", barr: "0", mark: "mic" },
