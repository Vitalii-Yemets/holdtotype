...
const PALETTES = {
  ...
  neon: { bg: "#150a22", panel: "#1d0e30", line: "#4a2472", text: "#f3b6e4", hi: "#46e0ff", dim: "#b06ee0", faint: "#7d4fae", warn: "#ffd24a", bad: "#ff4d7d", rec: "#ff4d7d", field: "#1e0f33", card: "#231039", soft: "#2a1442", navon: "#2b1240", on: "#4a2472", btnbgh: "linear-gradient(90deg,#ff7ad3,#6ce7ff)", btn2bg: "linear-gradient(90deg,#ff5fc8,#46e0ff)", btn2fg: "#150a22", btn2line: "transparent", btn2bgh: "linear-gradient(90deg,#ff7ad3,#6ce7ff)", dangerbg: "#ff4d7d", dangerfg: "#150a22", dangerbgh: "#ff6f97", dot: "#46e0ff", focus: "#46e0ff" },
