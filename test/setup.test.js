...
const values = {
  ...
  FONT_FACE: "/* font */",
  THEME_VARS: "--bg:#0b0f0c;--panel:#0e1410;--line:#1d4a2b;--green:#3cff6e;--hi:#3cff6e;--dim:#20a34a;--faint:#14803a;--amber:#ffb347;--bad:#ff7b6b;--rgb:60,255,110;--field:#08100b;--titlebg:transparent;--btnbg:#101d14;--btnfg:#3cff6e;--btnline:#20a34a;--fs:14px;--fieldpad:6px 10px;--ctlfs:12.5px;--wb:700;--caps:uppercase;--ls:1px;--r:0px;--bw:1px;--scan:1;--shadow:none;--glow:0 0 7px rgba(60,255,110,.55);--higlow:0 0 8px rgba(60,255,110,.6);--iconglow:none;--brandbg:none;--brandclip:border-box;--brandfill:currentColor",
  FINISH: "FINISH",
  RETRY: "RETRY",
  BACK: "BACK",
