...
| **Rules** | where punctuation comes from, the recognition dictionary, replacements, voice commands with save-to-file and load-from-file, and the per-application insertion rules |
