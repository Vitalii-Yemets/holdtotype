...
- 🗣️ **8 UI languages** — English, Ukrainian, Russian, German, French, Spanish, Italian, Polish. Every screen, dialog, overlay and error is translated; only the long in-app guide in About is still English outside English and Russian. Switching is instant, "Same as system" follows Windows.
